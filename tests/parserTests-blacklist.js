...
add("wt2html", "Don't break link parsing if language converter markup is in the caption.");
add("wt2html", "Don't break image parsing if language converter markup is in the caption.");
add("wt2html", "Don't break list handling if language converter markup is in the item.");
add("wt2html", "Don't break table handling if language converter markup is in the cell.");
...
add("wt2wt", "Templates: Indent-Pre: 1f: Wrapping should be based on expanded content");
...
add("wt2wt", "2. Lists with start-of-line-transparent tokens before bullets: Template close");
...
add("wt2wt", "Don't break image parsing if language converter markup is in the caption.");
add("wt2wt", "Don't break table handling if language converter markup is in the cell.");
add("wt2wt", "Bug 529: Uncovered bullet leaving empty list, normally removed by tidy");
...
add("html2html", "Link with 4 brackets");
add("html2html", "Piped link with extlink-like text");
...
add("html2html", "Don't break link parsing if language converter markup is in the caption.");
add("html2html", "Don't break image parsing if language converter markup is in the caption.");
add("html2html", "Don't break list handling if language converter markup is in the item.");
...
add("html2wt", "Link with 4 brackets");
add("html2wt", "Piped link with extlink-like text");
...
add("html2wt", "CSS safety test: vertical tab");
add("html2wt", "MSIE CSS safety test: Fullwidth");
add("html2wt", "MSIE CSS safety test: IPA extensions");
add("html2wt", "MSIE CSS safety test: sup/sub script");
add("html2wt", "MSIE CSS safety test: Repetition markers");
...
add("html2wt", "Don't break link parsing if language converter markup is in the caption.");
add("html2wt", "Don't break image parsing if language converter markup is in the caption.");
add("html2wt", "Don't break list handling if language converter markup is in the item.");
...
add("selser", "<nowiki> inside <pre> (bug 13238) [0,0,[1,3],4,2]", "<pre>\n<nowiki>\n</pre>\n<pre>\n<nowiki></nowiki></pre>h5z9mczgkhzx5hfr4x2g6badu0udi<pre><nowiki><nowiki></nowiki>Foo<nowiki></nowiki></nowiki></pre>");
...
add("selser", "2a. Indent-Pre and tables [4,[2,[1,3]]]", "khzx92odevc84cxr\n{|<!--ofhj20adrkqsq0k9-->\n |- data-foobar=\"dkq0wspbd866flxr\"\n !h1!!h2\n |foo||bar\n |}");
...
add("selser", "Table security: embedded pipes (http://lists.wikimedia.org/mailman/htdig/wikitech-l/2006-April/022293.html) [1]", "{| data-foobar=\"m95o8fzp94ahh0k9\"\n| |[ftp://|x||]\" onmouseover=\"alert(document.cookie)\">test|}");
add("selser", "Table security: embedded pipes (http://lists.wikimedia.org/mailman/htdig/wikitech-l/2006-April/022293.html) [[3,2]]", "{|<!--15gwlb38dkievcxr-->\n| |[ftp://|x||]\" onmouseover=\"alert(document.cookie)\">test|}");
add("selser", "Table security: embedded pipes (http://lists.wikimedia.org/mailman/htdig/wikitech-l/2006-April/022293.html) [[3,[2]]]", "{|<!--7ddobi4y5mte29-->\n| |[ftp://|x||]\" onmouseover=\"alert(document.cookie)\">test|}");
add("selser", "Table security: embedded pipes (http://lists.wikimedia.org/mailman/htdig/wikitech-l/2006-April/022293.html) [[0,[[[2,4],0]]]]", "{|\n| |9aquzoici5h77gb9[1m40dckorpg8ehfr||]\" onmouseover=\"alert(document.cookie)\">test|}");
add("selser", "Table security: embedded pipes (http://lists.wikimedia.org/mailman/htdig/wikitech-l/2006-April/022293.html) [[0,[[[0,1],0]]]]", "{|\n| |[ftp://|x||]\" onmouseover=\"alert(document.cookie)\">test|}");
add("selser", "Table security: embedded pipes (http://lists.wikimedia.org/mailman/htdig/wikitech-l/2006-April/022293.html) [[4,1]]", "{|<!--cgy78zk496nwxw29-->\n| |[ftp://|x||]\" onmouseover=\"alert(document.cookie)\">test|}");
...
add("selser", "Table security: embedded pipes (http://lists.wikimedia.org/mailman/htdig/wikitech-l/2006-April/022293.html) [[0,[[1,[3]]]]]", "{|\n|  data-foobar=\"safp11r8l8k0rudi\"|[ftp://|x|||}");
add("selser", "Table security: embedded pipes (http://lists.wikimedia.org/mailman/htdig/wikitech-l/2006-April/022293.html) [[2,[[3,1]]]]", "{|<!--sawi8z0v68rm5cdi-->\n|| data-foobar=\"e62fl3mcnqld6lxr\" |]\" onmouseover=\"alert(document.cookie)\">test|}");
add("selser", "Table security: embedded pipes (http://lists.wikimedia.org/mailman/htdig/wikitech-l/2006-April/022293.html) [[4,2]]", "{|<!--52w2ims97e2sxlxr--><!--y6fidtgecex9a4i-->\n| |[ftp://|x||]\" onmouseover=\"alert(document.cookie)\">test|}");
add("selser", "Table security: embedded pipes (http://lists.wikimedia.org/mailman/htdig/wikitech-l/2006-April/022293.html) [[4,[[[2,0],1]]]]", "{|<!--ds7hvmsv7vutbj4i-->\n| |35xiyenbgso72e29[ftp://|x|| data-foobar=\"s7a0bibzxxs6pqfr\" |]\" onmouseover=\"alert(document.cookie)\">test|}");
add("selser", "Table security: embedded pipes (http://lists.wikimedia.org/mailman/htdig/wikitech-l/2006-April/022293.html) [[0,2]]", "{|\n<!--argirnq6hdnjc3di-->| |[ftp://|x||]\" onmouseover=\"alert(document.cookie)\">test|}");
add("selser", "Table security: embedded pipes (http://lists.wikimedia.org/mailman/htdig/wikitech-l/2006-April/022293.html) [[3,1]]", "{|\n| |[ftp://|x||]\" onmouseover=\"alert(document.cookie)\">test|}");
...
add("selser", "Handling html with a div self-closing tag [0,3,0,4,1]", "<div title /><div title/>0z1eukxmytaz6w29<div data-foobar=\"jzl0rmosd4e7b9\" title/>\n<div title=bar />\n<div title=bar/>\n<div title=bar/ >");
...
add("selser", "Horizontal ruler (should it add that extra space?) [2,3,0,0,0,4]", "o5rwiutljxjsv2t9<hr><hr >\nfoo <hr\n>d35ei25187b0ggb9");
...
add("selser", "Parsoid: Make sure nested lists are serialized on their own line even if HTML contains no newlines [3,0,1,4,4]", "* foo\n** barp9ip31sqlfhwipb9fqsfuqrrsru23xr");
...
add("selser", "Fuzz testing: Parser21 [[0,[[[0,2,0],0,0]]]]", "{|\n! 6ro52eq6kkzf47viirc://{{ftp://a\" onmouseover=\"alert('hello world');\"\n||}");
...
add("selser", "Don't break image parsing if language converter markup is in the caption. [2]", "2dxoitx0bw7sc3di\n\n[[File:Foobar.jpg|-{R|caption}-]]");
add("selser", "Don't break image parsing if language converter markup is in the caption. [1]", "[[File:Foobar.jpg|-{R|caption}-]]");
