...
function validateId(expectedIds, doc) {
	...
	expectedIds.forEach(function(id, i) {
		elts[i].getAttribute('id').should.equal(id);
	});
}
...
var headingsWithWtChars = [
	...
	[ "=Some {{convert|1|km}} here=", "Some_1_kilometre_.280.62.C2.A0mi.29_here"],
];
...
var headingsWithEntities = [
	[ '=Red, Blue, Yellow=', 'Red.2C_Blue.2C_Yellow'],
...
var nonEnglishHeadings = [
	...
	[ "=बादलों का वगीर्करण=",".E0.A4.AC.E0.A4.BE.E0.A4.A6.E0.A4.B2.E0.A5.8B.E0.A4.82_.E0.A4.95.E0.A4.BE_.E0.A4.B5.E0.A4.97.E0.A5.80.E0.A4.B0.E0.A5.8D.E0.A4.95.E0.A4.B0.E0.A4.A3" ],
];
...
var edgeCases = [
	...
	[ "<h1>foo</h1>\n=foo=\n<h1 id='foo'>bar</h1>", 'foo_2', 'foo_3', 'foo' ],
];
