...
# $2 would be the changetree -- copy-paste it from a failing test in parserTests-blacklist.js
#
...
node $(dirname $0)/parserTests --selser --dump dom:post-changes --no-blacklist --trace selser --filter "$1" --changetree "$2"
