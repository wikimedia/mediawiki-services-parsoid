...
class OnlyInclude extends TokenHandler {
	...
	onOnlyInclude(token) {
		...
		var src = !this.options.inTemplate ? token.getWTSource(this.manager.env) : undefined;
		var attribs = [
