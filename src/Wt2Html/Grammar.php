...
private function a122($lc) {
 return $lc; 
}
private function a123($bullets, $c) {
 return $this->endOffset(); 
}
private function a124($bullets, $c, $cpos, $d) {
...
private function a125($bullets, $tbl, $line) {
...
private function a126($bullets, $c) {
