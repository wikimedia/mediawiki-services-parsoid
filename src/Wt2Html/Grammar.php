...
private function parseurl($silence, &$param_preproc) {
  ...
  for (;;) {
    ...
    // start choice_2
    if (preg_match("/[^ \\]\\[\\x0d\\x0a\"'<>\\x00- \\x7f&\\x{a0}\\x{1680}\\x{180e}\\x{2000}-\\x{200a}\\x{202f}\\x{205f}\\x{3000}{]/Au", $this->input, $r12, 0, $this->currPos)) {
      $r12 = $r12[0];
...
private function parseextlink($silence, $boolParams, &$param_preproc, &$param_th) {
  ...
  // addr <- $r15
  // start choice_2
  $r18 = $this->parseextlink_nonipv6url($boolParams | 0x8, $param_preproc, $param_th);
  if ($r18!==self::$FAILED) {
    goto choice_2;
  }
  $r18 = '';
