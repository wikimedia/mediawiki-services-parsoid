...
# Parsoid/PHP test
php bin/parse.php --domain $1 --title '$2' < $3 > $3.php.html
sed 's/<\/body>/<!--BOO--><\/body>/g;'    < $3.php.html > $3.php.new.html
php bin/parse.php --domain $1 --title '$2' --selser --oldtextfile $3 --oldhtmlfile $3.php.html < $3.php.new.html > $3.php.new
