...
var AUTOURL_BAD_PAREN = new RegExp("^" + NOT_LTGTNBSP + "[" + TRAILING_PUNCT + "]*[" + EXT_LINK_URL_CLASS + TRAILING_PUNCT + "]");
// if the URL has an doesn't have an open paren in it, TRAILING PUNCT will
// include ')' as well.
var AUTOURL_BAD_NOPAREN = new RegExp("^" + NOT_LTGTNBSP + "[" + TRAILING_PUNCT + "\\)]*[" + EXT_LINK_URL_CLASS + TRAILING_PUNCT + "\\)]");
