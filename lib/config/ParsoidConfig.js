...
ParsoidConfig.prototype.initMwApiMap = function() {
	...
	Object.keys(sitematrix).forEach((key) => {
		var val = sitematrix[key];
		if (!Number.isNaN(Number(key))) {
			val.site.forEach(insertInMaps.bind(this, undefined));
...
/**
 * @borrows #setMwApi as #setInterwiki
...
/**
 * @borrows #removeMwApi as #removeInterwiki
...
/**
 * @property {boolean} Return a 406 if unable to provide suitable content.
 */
