...
var WTUtils = ParsoidExtApi.WTUtils;
var Promise = ParsoidExtApi.Promise;
var Sanitizer = ParsoidExtApi.Sanitizer;
...
RefGroup.prototype.renderLine = function(env, refsList, ref) {
	...
	if (ref.content) {
		...
		DOMUtils.visitDOM(reftextSpan, DOMDataUtils.loadDataAttribs);
	}
...
References.prototype.extractRefFromNode = function(node, refsData, cite,
	...
	DOMUtils.visitDOM(c, DOMDataUtils.loadDataAttribs);
	...
	DOMUtils.visitDOM(c, DOMDataUtils.storeDataAttribs);
...
var Cite = function() {
	...
	this.config = {
		name: 'cite',
		domProcessors: {
			wt2htmlPostProcessor: this._wt2htmlPostProcessor.bind(this),
			html2wtPreProcessor: this._html2wtPreProcessor.bind(this),
		},
		tags: [
			{
				name: 'ref',
