...
var pCaption = Promise.async(function *(data) {
	...
	var doc = yield PipelineUtils.promiseToProcessContent(
		data.manager.env,
		data.manager.frame,
		caption.v,
		{
...
var pLine = Promise.async(function *(data, obj) {
	...
	var doc = yield PipelineUtils.promiseToProcessContent(env, data.manager.frame, wt, {
		pipelineType: 'text/x-mediawiki/full',
		pipelineOpts: {
			extTag: 'gallery',
			expandTemplates: true,
...
var tokenHandler = function(manager, pipelineOpts, extToken, cb) {
	...
	.then(function(ret) {
		...
		var tokens = PipelineUtils.buildDOMFragmentTokens(env, extToken, doc.body, addAttrs, {
