...
PreHandler.prototype.onNewline = function (token, manager, cb) {
	...
	env.log("trace/pre", this.manager.pipelineId, "NL    |", PreHandler.STATE_STR[this.state], "|", function() { return JSON.stringify(token); });
	...
	env.log("debug/pre", this.manager.pipelineId, "---->  ", function() { return JSON.stringify(ret); });
...
PreHandler.prototype.onAny = function ( token, manager, cb ) {
	...
	env.log("trace/pre", this.manager.pipelineId, "any   |", PreHandler.STATE_STR[this.state], "|", function() { return JSON.stringify(token); });
