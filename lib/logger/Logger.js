 ...
 * @return {Promise} a Promise that will be fulfilled when all logging is
 *  complete.
 */
 ...
 * @returns Promise which is fulfilled when logging is complete.
 */
 ...
 * @param {LogData} logData
 * @return Promise when all logging is complete.
 */
