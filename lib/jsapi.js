...
var PNode, PNodeList, PComment, PExtLink, PHeading, PHtmlEntity, PTemplate, PText, PWikiLink;
...
Object.defineProperties(PNodeList.prototype, {
	...
	_querySelectorAll: { value: function(selector) {
		...
		var nodeFilter = function(node) {
			...
			if (/\bmw:Transclusion\b/.test(node.getAttribute('typeof') || '')) {
				return NodeFilter.FILTER_ACCEPT;
			}
	...
	filterComments: { value: function(opts) {
		return this._filter([], 'COMMENT', function(r, parent, node, opts) {
