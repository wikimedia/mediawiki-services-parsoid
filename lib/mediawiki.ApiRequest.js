...
PreprocessorRequest.prototype._handleJSON = function(error, data) {
	...
	setPageProperty(this.env, data.expandtemplates.modules, "extensionModules");
	setPageProperty(this.env, data.expandtemplates.modulescripts, "extensionModuleScripts");
	setPageProperty(this.env, data.expandtemplates.modulestyles, "extensionModuleStyles");
...
PHPParseRequest.prototype._handleJSON = function(error, data) {
	...
	setPageProperty(this.env, data.parse.modulescripts, "extensionModuleScripts");
	setPageProperty(this.env, data.parse.modulestyles, "extensionModuleStyles");
