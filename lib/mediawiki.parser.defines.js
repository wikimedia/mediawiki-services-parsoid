 ...
 * @member Token
 *
 * Private helper for genericTokenMethods - store the original value of an
 * attribute in a token's dataAttribs.
 *
 * @param {string} name
 * @param {Mixed} value
...
SelfclosingTagTk.prototype.multiTokenArgToString = function(key, arg, indent, indentIncrement) {
	...
	return {present: present, str: str}; // jscs:ignore jsDoc
};
