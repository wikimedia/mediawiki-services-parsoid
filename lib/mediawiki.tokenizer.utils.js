...
var tu = {
	...
	*/
	...
	//    We suppress that behaviour at the cost of introducing a dirty diff,
	//    but selser should take care of it.
	//
	//  * If the comment's data matches /^-?>/, html5 will end the comment,
	//    introducing roundtrip diffs. For example, <!-->stuff<--> breaks up as
	...
	//    in the spec [1]. Normalize to this syntax in order to emit valid XML.
	//
