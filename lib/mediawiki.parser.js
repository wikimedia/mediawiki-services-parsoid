...
var TokenTransformManager = require('./mediawiki.TokenTransformManager.js');
var ExtensionHandler = require('./ext.core.ExtensionHandler.js').ExtensionHandler;
var NoIncludeOnly = require('./ext.core.NoIncludeOnly.js');
var QuoteTransformer = require('./ext.core.QuoteTransformer.js').QuoteTransformer;
var TokenStreamPatcher = require('./ext.core.TokenStreamPatcher.js').TokenStreamPatcher;
var PreHandler = require('./ext.core.PreHandler.js').PreHandler;
var ParagraphWrapper = require('./ext.core.ParagraphWrapper.js').ParagraphWrapper;
...
var AttributeExpander = require('./ext.core.AttributeExpander.js').AttributeExpander;
var ListHandler = require('./ext.core.ListHandler.js').ListHandler;
var LinkHandler = require('./ext.core.LinkHandler.js');
var BehaviorSwitch = require('./ext.core.BehaviorSwitchHandler.js');
var DOMFragmentBuilder = require('./ext.core.DOMFragmentBuilder.js').DOMFragmentBuilder;
var TreeBuilder = require('./mediawiki.HTML5TreeBuilder.node.js').TreeBuilder;
var DOMPostProcessor = require('./mediawiki.DOMPostProcessor.js').DOMPostProcessor;
...
ParserPipelineFactory.prototype.parse = function(env, src, expansions, cb) {
	var self = this;
