...
ParsoidLogger.prototype.registerLoggingBackends = function(defaultLogLevels, parsoidConfig, linter) {
	...
	var loggerBackend = (typeof(parsoidConfig.loggerBackend) === 'function') ?
		parsoidConfig.loggerBackend : this.getDefaultBackend();
...
ParsoidLogger.prototype.locationMsg = function(logData) {
	var location = '[' + logData.logType + '][' + this.env.conf.wiki.iwp + '/' + this.env.page.name;
