...
function DOMPostProcessor(env, options) {
	...
	domVisitor2.addHandler( 'td', tableFixer.handleTableCellTemplates.bind( tableFixer, env ) );
	domVisitor2.addHandler( 'th', tableFixer.handleTableCellTemplates.bind( tableFixer, env ) );
