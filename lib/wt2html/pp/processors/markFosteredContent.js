 ...
 */
function createNodeWithAttributes(document, type, attrs) {
...
function insertTransclusionMetas(env, fosterBox, table) {
	...
	var s = createNodeWithAttributes(fosterBox.ownerDocument, "meta", {
		"about": aboutId,
	...
	var e = createNodeWithAttributes(table.ownerDocument, "meta", {
		"about": aboutId,
