...
function cleanupAndSaveDataParsoid(node, env, atTopLevel, tplInfo) {
	...
	if (atTopLevel) {
		...
		if (tplInfo
			...
			// <section> tags and template-wrapping interactions forces
			// us to preserve dsr on original first template node because
			// we strip <section> tags in html->wt direction and need dsr here.
