...
var { AttributeTransformManager } = require('../TokenTransformManager.js');
var { PegTokenizer } = require('../tokenizer.js');
var Promise = require('../../utils/promise.js');
var TokenHandler = require('./TokenHandler.js');
var { Util } = require('../../utils/Util.js');

var { NlTk, TagTk, SelfclosingTagTk } = require('../parser.defines.js');
...
class AttributeExpander extends TokenHandler {
		...
		for (var i = 0, l = tokens.length; i < l; i++) {
			...
			if (i === nlTkPos) {
				...
				if (wrapTemplates && t.constructor === SelfclosingTagTk) {
					var type = t.getAttribute("typeof");
					var typeMatch = type && type.match(this.metaTypeMatcher());
	...
	*buildExpandedAttrsG(token, expandedAttrs) {
		...
		var wrapTemplates = !this.options.inTemplate;
