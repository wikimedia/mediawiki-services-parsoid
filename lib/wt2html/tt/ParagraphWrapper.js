...
var { CommentTk, EOFTk, NlTk, TagTk, SelfclosingTagTk, EndTagTk } =
...
class ParagraphWrapper extends TokenHandler {
	constructor(manager, options) {
		...
		// The superclass constructor calls init() which then calls reset()
		// which initializes the various class fields.  The initial state
		// is copied below as documentation of what fields are present.
		this.inPre = false;
		...
		this.nlWsTokens = [];
		this.newLineCount = 0;
		// this.currLine = { ... }; // see #resetCurrLine()
	}
