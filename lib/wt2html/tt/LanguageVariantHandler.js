...
const PipelineUtils = require('../../utils/PipelineUtils.js').PipelineUtils;
const JSUtils = require('../../utils/jsutils.js').JSUtils;
const Promise = require('../../utils/promise.js');
const TokenHandler = require('./TokenHandler.js');
const defines = require('../parser.defines.js');

// define some constructor shortcuts
const KV = defines.KV;
const EOFTk = defines.EOFTk;
const TagTk = defines.TagTk;
const EndTagTk = defines.EndTagTk;
...
class LanguageVariantHandler extends TokenHandler {
	 ...
	 */
	*onLanguageVariantG(token, frame) {
