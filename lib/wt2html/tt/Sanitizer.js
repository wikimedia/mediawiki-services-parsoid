...
Sanitizer.prototype.sanitizeTokens = function(tokens) {
	...
	tokens.forEach(function(token) {
		if (token.name && (token.name === 'a' || token.name === 'link')) {
...
Sanitizer.prototype.register = function(manager) {
	...
	manager.addTransform(this.onAnchor.bind(this), "Sanitizer:onAnchor", this.handledRank, 'tag', 'link');
...
Sanitizer.prototype.onAnchor = function(token) {
	// Literal html tokens weren't generated by us and should fall back to the
...
Sanitizer.prototype.normalizeCss = function(text) {
	...
	text = text.replace(this.constants.cssDecodeRE, function cssDecodeCallback() {
		var c;
