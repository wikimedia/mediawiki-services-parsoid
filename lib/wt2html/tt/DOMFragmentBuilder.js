...
var { TagTk,EOFTk,SelfclosingTagTk,EndTagTk } = require('../parser.defines.js');
...
class DOMFragmentBuilder extends TokenHandler {
	...
	wrapDOMFragment(cb, scopeToken, opts, dom) {
		...
		var toks = DOMUtils.buildDOMFragmentTokens(this.manager.env, scopeToken, dom.body, false, opts);
