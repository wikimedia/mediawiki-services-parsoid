...
var handleLinkNeighbours = require('./pp/dom.t.handleLinkNeighbours.js').handleLinkNeighbours;
var liFixups = require('./pp/dom.t.liFixups.js');
var handlePres = require('./pp/handlePres.js').handlePres;
var handleUnbalancedTables = require('./pp/handleUnbalancedTables.js').handleUnbalancedTables;
var markFosteredContent = require('./pp/markFosteredContent.js').markFosteredContent;
var markTreeBuilderFixups = require('./pp/markTreeBuilderFixups.js').markTreeBuilderFixups;
var normalize = require('./pp/normalize.js').normalize;
var cleanupFormattingTagFixup = require('./pp/cleanupFormattingTagFixup.js').cleanupFormattingTagFixup;
var migrateTemplateMarkerMetas = require('./pp/migrateTemplateMarkerMetas.js').migrateTemplateMarkerMetas;
var migrateTrailingNLs = require('./pp/migrateTrailingNLs.js').migrateTrailingNLs;
var TableFixups = require('./pp/dom.t.TableFixups.js');
var unpackDOMFragments = require('./pp/dom.t.unpackDOMFragments.js').unpackDOMFragments;
...
DOMPostProcessor.prototype.addMetaData = function(document) {
	...
	appendToHead(document, 'meta', {
		'property': 'mw:html-content-type',
		'content': env.conf.parsoid.HTML_CONTENT_TYPE,
	});
	if (!env.storeDataParsoid) {
		// For inline data-parsoid, add version information
		appendToHead(document, 'meta', {
			'property': 'mw:data-parsoid-content-type',
			'content': env.conf.parsoid.DATA_PARSOID_CONTENT_TYPE,
		});
	}
	...
	if (env.storeDataParsoid) {
		...
		DU.addAttributes(script, {
			id: "mw-data-parsoid",
			type: env.conf.parsoid.DATA_PARSOID_CONTENT_TYPE,
		});
