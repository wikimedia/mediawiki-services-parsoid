...
function stripUnnecessaryQuoteNowikis(wt) {
	...
	// Within the matched quote-segments, be conservative and don't match higher-priority
	// parser characters like [{< -- used for links and templates. This should prevent
