...
function WikitextSerializer( options ) {
	...
	WikitextSerializer.prototype.trace = this.env.log.bind(this.env, "trace/wts");
	WikitextSerializer.prototype.debug = this.env.log.bind(this.env, "debug/wts");
...
WSP._serializeNode = function( node, state, cb) {
	...
	switch( node.nodeType ) {
		...
		case node.TEXT_NODE:
			...
			this.trace("TEXT:", node.nodeValue, "; SOL: ", state.onSOL);
		...
		case node.COMMENT_NODE:
			...
			this.trace("CMT :", "<!--", node.nodeValue, "--> ; SOL: ", state.onSOL);
