 ...
 * character.
 */
TableFixups.prototype.collectAttributishContent = function(node, templateWrapper) {
	var buf = [],
		nodes = [],
...
TableFixups.prototype.reparseTemplatedAttributes = function(env, node, templateWrapper) {
	...
	var attributishContent = this.collectAttributishContent(node, templateWrapper),
