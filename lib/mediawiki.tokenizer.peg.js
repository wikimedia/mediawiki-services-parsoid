...
PegTokenizer.prototype._processText = function( text, fullParse ) {
	if ( !this.tokenizer ) {
		...
		*/
		...
		//	tokenizerSource + ';';
		// write tokenizer to a file.	101
        //var tokenizerFilename = __dirname + '/mediawiki.tokenizer.js';	102
		//fs.writeFileSync(tokenizerFilename, 'module.exports = ' + tokenizerSource, 'utf8');
...
PegTokenizer.prototype.tokenizeURL = function( text ) {
	var args = { pegTokenizer: this, env: this.env, pegIncludes: pegIncludes };
