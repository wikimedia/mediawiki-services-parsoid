...
var tagHandlers = JSUtils.mapObject({
	...
	th: {
		handle: Promise.async(function *(node, state, wrapperUnmodified) {
			...
			const previousTrailingSpace = inWideTH ? getTrailingSpace(state, DU.previousNonDeletedSibling(node), '') : '';
	...
	td: {
		handle: Promise.async(function *(node, state, wrapperUnmodified) {
			...
			const previousTrailingSpace = inWideTD ? getTrailingSpace(state, DU.previousNonDeletedSibling(node), '') : '';
			const leadingSpace = getLeadingSpace(state, node, '');
