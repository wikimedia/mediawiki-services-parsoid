...
WSP.getAttributeValueAsShadowInfo = function(node, key) {
	return this.getAttributeValue(node, key, null)
	.then(function(v) {
		if (v === null) { return v; }
		return {
			value: v,
...
WSP.serializedImageAttrVal = Promise.method(function(dataMWnode, htmlAttrNode, key) {
	return this.getAttributeValueAsShadowInfo(dataMWnode, key)
	.then(function(v) {
...
WSP._serializeNode = Promise.method(function(node) {
	...
	return method.call(this, node, domHandler).then((nextNode) => {
