 ...
 * (RegExpConstrainedText is notably missing)
 */
ConstrainedText._types = [ ConstrainedText, WikiLinkText, ExtLinkText, AutoURLLinkText, MagicLinkText, LanguageVariantText ];
