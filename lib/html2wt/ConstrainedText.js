...
ConstrainedText._fromSelSer = function(text, node, dataParsoid, env, opts) {
	...
	var lastChild = DU.lastNonDeletedChild(node);
...
AutoURLLinkText.prototype.escape = function(state) {
	var r = AutoURLLinkText.super_.prototype.escape.call(this, state);
 ...
 * @param {Node} node
 */
var LanguageVariantText = function LanguageVariantText(text, node) {
	LanguageVariantText.super_.call(this, {
		text: text,
		node: node,
...
LanguageVariantText._fromSelSer = function(text, node, dataParsoid, env) {
