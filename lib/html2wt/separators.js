...
/**
 * This code assumes that the DOM is in normalized form with no run of text nodes.
 * Accumulate whitespace from the text node into state.sep.src
 *
 * returns true if the entire text node was all separator content.
 */
var handleSeparatorText = function(node) {
