 ...
 */
SSP.serializeChildren = Promise.async(function *(node, wtEscaper, firstChild) {
 ...
 */
SSP._kickOffSerialize = Promise.async(function *(node, wtEscaper) {
	this.updateSep(node);
	this.currNodeUnmodified = false;
 ...
 */
SSP._serializeChildrenToString = Promise.async(function *(node, wtEscaper, inState) {
