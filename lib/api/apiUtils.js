...
apiUtils.returnDowngrade = function(downgrade, metrics, env, revision, res, contentmodel) {
	...
	apiUtils.wt2htmlRes(res, html, pb, contentmodel, DU.findHttpEquivHeaders(doc), env.outputContentVersion);
};
...
apiUtils.updateRedLinks = Promise.async(function *(env, revision, res, contentmodel) {
	...
	apiUtils.wt2htmlRes(res, html, pb, contentmodel, DU.findHttpEquivHeaders(doc), env.inputContentVersion);
});
