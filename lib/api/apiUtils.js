...
apiUtils._findHeaders = function(doc) {
	// extract content language and vary headers from the HTML, if present
...
apiUtils.downgrade2to1 = function(env, revision, res, contentmodel) {
	...
	apiUtils.wt2htmlRes(env, res, html, pb, contentmodel, apiUtils._findHeaders(doc));
};
 ...
 * @param {string} [contentmodel]
 */
apiUtils.wt2htmlRes = function(env, res, html, pb, contentmodel, headers) {
	if (pb) {
		var response = {
