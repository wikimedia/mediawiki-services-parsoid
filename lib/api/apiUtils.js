...
apiUtils.htmlContentType = function(env) {
	return 'text/html; charset=utf-8; profile="https://www.mediawiki.org/wiki/Specs/HTML/' + env.contentVersion + '"';
};
...
apiUtils.pagebundleContentType = function(env) {
	return 'application/json; charset=utf-8; profile="https://www.mediawiki.org/wiki/Specs/pagebundle/' + env.contentVersion + '"';
};
 ...
 * @return {Boolean}
 */
apiUtils.validateAndSetContentVersion = function(res) {
