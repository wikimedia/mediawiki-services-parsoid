...
add("wt2html", "Image with link parameter, protocol-less URL target (parsoid)");
...
add("wt2html", "Image with link parameter (URL target) and unnamed parameter (parsoid)");
...
add("html2html", "Image with link parameter (URL target) and unnamed parameter (parsoid)");
...
add("html2wt", "Image with link parameter, protocol-less URL target (parsoid)");
...
add("html2wt", "Image with link parameter (URL target) and unnamed parameter (parsoid)");
