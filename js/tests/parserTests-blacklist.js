...
add("html2html", "Parsoid: External links: wiki links within external link (Bug 3695)");
...
add("selser", "Template-generated attribute string (k='v') [2]", "p6mic904q6wrvn29\n\n<span {{attr_str|id|v1}}>bar</span>");
add("selser", "Template-generated attribute string (k='v') [1]", "<span {{attr_str|id|v1}}>bar</span>");
add("selser", "Template-generated attribute string (k='v') [[2]]", "2r17p7ijxvjqncdi<span {{attr_str|id|v1}}>bar</span>");
add("selser", "Template-generated attribute string (k='v') [[[3]]]", "<span {{attr_str|id|v1}}>bar</span>");
add("selser", "Template-generated attribute string (k='v') [[[2]]]", "<span {{attr_str|id|v1}}>bar</span>");
add("selser", "Template-generated attribute string (k='v') [[[4]]]", "<span {{attr_str|id|v1}}>bar</span>");
...
add("selser", "0. includeonly around the entire attribute [1]", "<span <includeonly>id=\"v1\"</includeonly><noinclude>id=\"v2\"</noinclude>>bar</span>");
add("selser", "0. includeonly around the entire attribute [[2]]", "8gtj3g224yrpb9<span <includeonly>id=\"v1\"</includeonly><noinclude>id=\"v2\"</noinclude>>bar</span>");
add("selser", "0. includeonly around the entire attribute [2]", "iq0f3f4t35t2csor\n\n<span <includeonly>id=\"v1\"</includeonly><noinclude>id=\"v2\"</noinclude>>bar</span>");
add("selser", "0. includeonly around the entire attribute [[[2]]]", "<span <includeonly>id=\"v1\"</includeonly><noinclude>id=\"v2\"</noinclude>>bar</span>");
add("selser", "0. includeonly around the entire attribute [[[4]]]", "<span <includeonly>id=\"v1\"</includeonly><noinclude>id=\"v2\"</noinclude>>bar</span>");
add("selser", "0. includeonly around the entire attribute [[[3]]]", "<span <includeonly>id=\"v1\"</includeonly><noinclude>id=\"v2\"</noinclude>>bar</span>");
...
add("selser", "Bug 2095: link with pipe and three closing brackets, version 2 [[3,2]]", "99keiiqxlrp5jyvi\n");
add("selser", "Bug 2095: link with pipe and three closing brackets, version 2 [[0,1]]", "[[Main Page|[http://example.com/]]][http://example.com/]\n");
add("selser", "Bug 2095: link with pipe and three closing brackets, version 2 [[1,[3]]]", "[[Main Page|<nowiki/>]]\n");
add("selser", "Bug 2095: link with pipe and three closing brackets, version 2 [[2,0]]", "d68c64xhjfrsh5mi[[Main Page|[http://example.com/]]]\n");
...
add("selser", "Bug 2095: link with pipe and three closing brackets, version 2 [[4,0]]", "c9tbsesncl5idx6r\n");
