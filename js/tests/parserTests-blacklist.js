...
add("wt2wt", "3b. Indent-Pre and block tags (pre-content on separate line)");
add("wt2wt", "HTML-pre: 1. embedded newlines");
add("wt2wt", "HTML-pre: 2: indented text");
...
add("selser", "<nowiki> inside <pre> (bug 13238) [0,3,1,0,3]", "<pre>\n<nowiki>\n</pre>\n<pre data-foobar=\"d4vv2qk2d3wel8fr\"><nowiki></nowiki>\n</pre>\n");
...
add("selser", "<nowiki> inside <pre> (bug 13238) [0,4,0,3,4]", "<pre>\n<nowiki>\n</pre>hn5q4u2x5qiio1or<pre>\n<nowiki></nowiki>\n</pre>8wy3o72mveoecdi");
...
add("selser", "<nowiki> inside <pre> (bug 13238) [1,2,0,0,3]", "<pre data-foobar=\"p2u0d9qqxhxxyldi\"><nowiki>\n</pre>0h6wfuf5at2wqaor\n<pre>\n<nowiki></nowiki>\n</pre>\n");
add("selser", "<nowiki> inside <pre> (bug 13238) [2,2,[2,0],3,[0,0,2,0]]", "pheb7wncog1ll3di<pre>\n<nowiki>\n</pre>cx6h0arhmsz41jor\n<pre>ywnrib86wthb0529<nowiki></nowiki>\n</pre>\n<pre><nowiki>&lt;nowiki&gt;</nowiki>Foobackovm0c9dx6r<nowiki></nowiki></nowiki></pre>");
...
add("selser", "<nowiki> and <pre> preference (first one wins) [0,0,[[2],3],0,3,2]", "<pre>\n<nowiki>\n</pre>\n</nowiki>\n\nvdd6k1gco4h4obt9\n");
...
add("selser", "<nowiki> and <pre> preference (first one wins) [[2],0,1,0,2,4]", "<pre>8ko393dqfxxvquxr<nowiki>\n</pre>\n</nowiki>\n</pre>\n\nmgac8wudaavy4x6r\n\n<nowiki>\n<pre>\n<nowiki>\n</pre>\n</nowiki>\n</pre>1js1f9r56vl5wmi");
...
add("selser", "<nowiki> and <pre> preference (first one wins) [2,0,0,4,4,2]", "y8vpa6w0zqynl8fr<pre>\n<nowiki>\n</pre>\n</nowiki>\n</pre>cmlrx73di37bvs4idljqhg05gz74lsorfmq2iv96aasdzpvi\n");
add("selser", "<nowiki> and <pre> preference (first one wins) [2,4,[2,0],4,[[3],0],0]", "kg5ysu07a5uerk9<pre>\n<nowiki>\n</pre>bs9yk9e1o4r3haor\nxjgfdio1kqu59udi</nowiki>\n</pre>v3i2tp3j1431sjor\n\n<nowiki></nowiki>\n</pre>\n");
add("selser", "Empty pre; pre inside other HTML tags (bug 54946) [1,0,2,3,0]", "a\n\n2j0b5uc25ht9y66r<div><pre>\nfoo\n</pre></div>\n<pre></pre>");
add("selser", "Empty pre; pre inside other HTML tags (bug 54946) [[2],0,2,2,4]", "8ekwtn8px229y66ra\n\n6zwsai8gdk46ajor<div><pre>\nfoo\n</pre></div>izz6fn7q607ctyb9\n126o15068kbg9zfr");
add("selser", "Empty pre; pre inside other HTML tags (bug 54946) [0,0,1,4,0]", "a\n\n<div data-foobar=\"5edwkkpet6sz6w29\"><pre>\nfoo\n</pre></div>5nemphqh6hag7gb9<pre></pre>");
add("selser", "Empty pre; pre inside other HTML tags (bug 54946) [0,2,0,0,2]", "a9vxsiiday8wa5rk9\n\n<div><pre>\nfoo\n</pre></div>\na5p13gy1mx5bqpvi<pre></pre>");
add("selser", "Empty pre; pre inside other HTML tags (bug 54946) [[2],0,1,2,3]", "gcwimrwikq9i19k9a\n\n<div data-foobar=\"mk7scuhatjzto6r\"><pre>\nfoo\n</pre></div>kwu32l1leliejyvi\n");
...
add("selser", "3b. Indent-Pre and block tags (pre-content on separate line) [3,0,[0,2,0],0,[2,0,3],2,[3],0,1,0,[3],0,[[4]],2]", "\n<div>\nodoxl9m57yx5stt9\n foo\n</div>\n\n<center>m83qshmuhz2jfw29\n foo\n</center>gmozm9193fim5cdi\n\n<blockquote></blockquote>\n\n<blockquote data-foobar=\"q23sttd967wah5mi\">\n<pre>\nfoo\n</pre>\n</blockquote>\n\n<table></table>\n\n<ul><li>1isv6b7l7xrvbo6r</li></ul>up378vgr2kq5xw29\n");
add("selser", "3b. Indent-Pre and block tags (pre-content on separate line) [4,0,2,0,0,0,0,0,[0,0,2],2,4,0,[2],0]", "n9yt28usw03eg66r\nxw4hsd8n6bnjyvi<div>\n foo\n</div>\n\n<center>\n foo\n</center>\n\n<blockquote>\n foo\n</blockquote>\n\n<blockquote>\n<pre>\nfoo\n</pre>2hjkp5n2eff4unmi\n</blockquote>mwaq3b1b75sif6r\nmt4eo5y30xktvs4i\n\n<ul><li>cucwv2mmqbprpb9</li><li>\n  foo\n</li></ul>\n");
add("selser", "3b. Indent-Pre and block tags (pre-content on separate line) [[2],3,[0,1,0],2,0,0,0,0,1,4,1,0,2,0]", "<p>98zdm4mmurw9udi\n foo\n</p>\n\n<div>\n foo\n</div>tgv62j4hedish5mi\n\n<center>\n foo\n</center>\n\n<blockquote>\n foo\n</blockquote>\n\n<blockquote data-foobar=\"56x7rsgni5wv1jor\">\n<pre>\nfoo\n</pre>\n</blockquote>xhnhaz3tjd1jor<table data-foobar=\"fyq42pysi0ey7gb9\"><tr><td>\n foo\n</td></tr></table>\n\n19l042ygt84obt9<ul><li>\n  foo\n</li></ul>\n");
add("selser", "3b. Indent-Pre and block tags (pre-content on separate line) [0,4,[2,1,2],4,[4,1,2],2,0,0,2,4,[1],0,[3],3]", "<p>\n foo\n</p>07srh6mguz4u0udi<div>99dx0b1lue5hr529\n foo\nx5xkdquv1ouk57b9\n</div>xi612bsndx7gmn29<center>pkmyorud8e0cnmi\n foo\nlrco7varema62yb9\n</center>y0aahtwvwijm7vi\n\n<blockquote>\n foo\n</blockquote>\n\n3hltzvpx1knmte29<blockquote>\n<pre>\nfoo\n</pre>\n</blockquote>p0y28orx3cdf5hfr<table><tr><td>\n foo\n</td></tr></table>\n\n<ul></ul>\n");
add("selser", "3b. Indent-Pre and block tags (pre-content on separate line) [3,0,[0,[4],0],0,[4,4,4],3,[2],0,[0,2,2],0,3,2,[1],0]", "\n<div>\n vt4d6jyx4grv0a4i\n</div>\n\n<center>oib0eg354jrcz0k9g8zepfa3lao72e29z26oicgbpbv2huxr</center>\n\n<blockquote>6m55hm1xiiesif6r\n foo\n</blockquote>\n\n<blockquote>\n350nin4sbb2r19k9<pre>\nfoo\n</pre>9hb3m0ekdowghkt9\n</blockquote>\n\npj7utswkw8us1yvi\n\n<ul><li data-foobar=\"4r0pivchmcf8ncdi\">\n  foo\n</li></ul>\n");
add("selser", "3b. Indent-Pre and block tags (pre-content on separate line) [0,0,4,2,[0,2,3],0,1,2,2,4,[[[[4,2,0]]]],2,[3],4]", "<p>\n foo\n</p>\n\ncjqcp4uvr8aaif6rgqlq33wbkb7qfr\n\n<center>\ng0t7y2ffelg9o1or\n foo\n</center>\n\n<blockquote data-foobar=\"vrm5oq7hcbaz6w29\">\n foo\n</blockquote>5y7l41q8eyvnp14i\nbwf9nka6yjlfecdi<blockquote>\n<pre>\nfoo\n</pre>\n</blockquote>rfaid075s2ejc3di<table><tr><td>rrwz4rafkulerk9t9zyh0d7wx9a4i\n foo\n</td></tr></table>7lmvhwp52nrssjor\n\n<ul></ul>eombzhhn1k9e8kt9");
...
add("selser", "HTML-pre: 1. embedded newlines [[3],2,0,3,1,0,[2]]", "<pre></pre>5ybgleb22vhg2e29\n\n<pre>\nfoo\n</pre>\n\n<pre data-foobar=\"9rnpnxw85n17zaor\">foo\n</pre>\n\n<pre>qz3itjpijx2prpb9\n\nfoo\n</pre>");
add("selser", "HTML-pre: 1. embedded newlines [[4],2,0,2,2,4,0]", "<pre>c613gzfv9dfe0zfr</pre>lhlr94vff88e61or\n\n<pre>\nfoo\n</pre>mfsobz59io83erk9\no2f5l4qjshwoecdi<pre>foo\n</pre>rjbnuw3teafqd7vi<pre>\nfoo\n</pre>");
...
add("selser", "Section extraction, <pre> around bogus header (bug 10309) [0,0,0,4,[3],0,[4]]", "== Section One ==\n<pre>\n=======\n</pre>beeafyunvkro1or\n==<nowiki/>==\nlry7jvz5go5vobt9");
add("selser", "Section extraction, <pre> around bogus header (bug 10309) [4,3,2,0,3,2,3]", "x7jyw5e83i5asjorxb05hkj8skocg14i<pre>\n=======\n</pre>\n\ni7uzsejzwcanhfr\n");
add("selser", "Section extraction, <pre> around bogus header (bug 10309) [3,0,0,0,[4],0,[3]]", "\n<pre>\n=======\n</pre>\n\n==ovf4hkfaj74on7b9==\n");
add("selser", "Section extraction, <pre> around bogus header (bug 10309) [[3],0,2,4,[3],2,0]", "==<nowiki/>==\n8a982tcfxtysc3di<pre>\n=======\n</pre>yeyggq1xc6yctyb9\n==<nowiki/>==\nipl4m8a16ud0wwmi\n\nstuff");
add("selser", "Section extraction, <pre> around bogus header (bug 10309) [1,3,2,0,1,3,4]", "== Section One ==\n5ng6hjqcx5gq4cxr<pre>\n=======\n</pre>\n\n== Section Two ==\nd6e7xowcq8478pvi");
add("selser", "Section extraction, <pre> around bogus header (bug 10309) [1,0,0,3,[2],2,1]", "== Section One ==\n<pre>\n=======\n</pre>\n\n==4bp0ntrttx7ds4i Section Two ==\nemnsi4khs1mrt3xr\n\nstuff");
add("selser", "Section extraction, <pre> around bogus header (bug 10309) [1,3,0,0,4,0,2]", "== Section One ==\n<pre>\n=======\n</pre>\n\n881rk5vjqfc1sjor\nllvxt0fw388mpldi\n\nstuff");
add("selser", "Section replacement, <pre> around bogus header (bug 10309) [1,2,0,4,0,0,[2]]", "== Section One ==\n35hcyok35hup7gb9\n<pre>\n=======\n</pre>p20lyqa4rseb3xr\n== Section Two ==\n2eliwudwq74lsorstuff");
add("selser", "Section replacement, <pre> around bogus header (bug 10309) [0,0,2,0,3,3,1]", "== Section One ==\ngqttb6xcrosqncdi<pre>\n=======\n</pre>\n\nstuff");
add("selser", "Section replacement, <pre> around bogus header (bug 10309) [0,0,2,3,2,4,4]", "== Section One ==\ndtp9c2adt80ejyvi<pre>\n=======\n</pre>c301vgk2zpm8to6r\n== Section Two ==\n8p76yk2ui7fogvi4w7zdkl3a2nsif6r");
add("selser", "Section replacement, <pre> around bogus header (bug 10309) [0,3,2,4,0,0,0]", "== Section One ==\nbd0j5f3sla24kj4i<pre>\n=======\n</pre>g1leo7hlh9z4cxr\n== Section Two ==\nstuff");
add("selser", "Section replacement, <pre> around bogus header (bug 10309) [0,2,0,0,2,4,[2]]", "== Section One ==\nade2za7daldz33di\n<pre>\n=======\n</pre>\n\nq9ftg5g4mab2csor\n== Section Two ==\n2qxopqxg0ny4lsor\n\n4k89dgtns4079zfrstuff");
add("selser", "Section replacement, <pre> around bogus header (bug 10309) [0,0,2,0,0,0,4]", "== Section One ==\nfm7nz0eyoo7mbo6r<pre>\n=======\n</pre>\n\n== Section Two ==\nn6hphvl1cfu07ldi");
add("selser", "Section replacement, <pre> around bogus header (bug 10309) [0,3,0,3,3,2,4]", "== Section One ==\n<pre>\n=======\n</pre>4wh443grye0o1or\no2s8nke3m9774x6r");
