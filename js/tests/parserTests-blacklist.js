...
add("selser", "Sanitizer: Validating the contents of the id attribute (bug 4515) [[2]]");
add("selser", "Sanitizer: Validating that <meta> and <link> work, but only for Microdata [[0,1,4,[0,0,0,4,0,0],0]]");
add("selser", "Sanitizer: Validating that <meta> and <link> work, but only for Microdata [[2,0,2,[0,0,0,0,0,2],0]]");
add("selser", "Sanitizer: Validating that <meta> and <link> work, but only for Microdata [2]");
add("selser", "Sanitizer: Validating that <meta> and <link> work, but only for Microdata [[0,1,4,[0,0,0,0,0,2],2]]");
add("selser", "Sanitizer: Validating that <meta> and <link> work, but only for Microdata [[4,1,0,[0,2,0,0,0,0],2]]");
add("selser", "Sanitizer: Validating that <meta> and <link> work, but only for Microdata [[4,[3],0,0,3]]");
add("selser", "Sanitizer: Validating that <meta> and <link> work, but only for Microdata [[0,0,4,[0,0,0,2,0,3],4]]");
add("selser", "Sanitizer: Validating that <meta> and <link> work, but only for Microdata [[4,1,0,[0,0,0,0,0,4],3]]");
add("selser", "Sanitizer: Validating that <meta> and <link> work, but only for Microdata [[0,3,4,[0,2,0,0,0,0],4]]");
add("selser", "Sanitizer: Validating that <meta> and <link> work, but only for Microdata [[0,[2],0,0,0]]");
add("selser", "Sanitizer: Validating that <meta> and <link> work, but only for Microdata [[0,0,0,2,3]]");
add("selser", "Sanitizer: Validating that <meta> and <link> work, but only for Microdata [1]");
add("selser", "Sanitizer: Validating that <meta> and <link> work, but only for Microdata [[2,2,0,2,0]]");
add("selser", "Sanitizer: Validating that <meta> and <link> work, but only for Microdata [[2,4,0,2,3]]");
add("selser", "Sanitizer: Validating that <meta> and <link> work, but only for Microdata [[3,0,4,2,0]]");
