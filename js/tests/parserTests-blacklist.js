...
add("wt2html", "Ref: 15. ref-tags with identical names should get identical indexes");
add("wt2html", "References: 2. references tag with group only outputs references from that group");
add("wt2html", "References: 3. ref list should be cleared after processing references");
add("wt2html", "References: 4. only referenced group should be cleared after processing references");
add("wt2html", "References: 5. ref tags in references should be processed while ignoring all other content");
...
add("html2html", "Ref: 15. ref-tags with identical names should get identical indexes");
add("html2html", "References: 2. references tag with group only outputs references from that group");
add("html2html", "References: 3. ref list should be cleared after processing references");
add("html2html", "References: 4. only referenced group should be cleared after processing references");
