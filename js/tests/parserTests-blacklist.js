...
add("wt2html", "Single-comment whitespace lines dont break lists, and neither do multi-comment whitespace lines");
add("wt2html", "Replacing whitespace with tabs still doesn't break the list (gerrit 78327)");
...
add("wt2wt", "Replacing whitespace with tabs still doesn't break the list (gerrit 78327)");
...
add("selser", "Replacing whitespace with tabs still doesn't break the list (gerrit 78327) [0,4,4,4,[[4]],4,3,3,0,4,3,4,2,4,2,0,[[4]]]");
add("selser", "Replacing whitespace with tabs still doesn't break the list (gerrit 78327) [[4],2,0,0,1,2,0,4,0,0,2,2,0,3,0,3,2]");
add("selser", "Replacing whitespace with tabs still doesn't break the list (gerrit 78327) [[4],3,0,0,2,2,3,3,[[4]],0,2,0,0,3,0,2,0]");
add("selser", "Replacing whitespace with tabs still doesn't break the list (gerrit 78327) [2,3,2,2,[2],2,4,0,0,3,4,4,4,0,2,0,4]");
add("selser", "Replacing whitespace with tabs still doesn't break the list (gerrit 78327) [[3],3,3,4,1,2,3,2,[[3]],0,0,4,0,3,2,2,1]");
