...
add("selser", "Link containing double-single-quotes '' in text embedded in italics (bug 4598 sanity check) [[[2,0],2,0]]");
add("selser", "Link containing double-single-quotes '' in text embedded in italics (bug 4598 sanity check) [[1,3,2]]");
...
add("selser", "Link containing double-single-quotes '' in text embedded in italics (bug 4598 sanity check) [[1,4,2]]");
add("selser", "Link containing double-single-quotes '' in text embedded in italics (bug 4598 sanity check) [[[2,2],[0,[3]],3]]");
add("selser", "Link containing double-single-quotes '' in text embedded in italics (bug 4598 sanity check) [[[0,[2]],4,0]]");
add("selser", "Link containing double-single-quotes '' in text embedded in italics (bug 4598 sanity check) [[3,[0,1],2]]");
add("selser", "Link containing double-single-quotes '' in text embedded in italics (bug 4598 sanity check) [[[0,[4]],[3,0],3]]");
...
add("selser", "Link containing double-single-quotes '' in text embedded in italics (bug 4598 sanity check) [[2,1,3]]");
...
add("selser", "Unbalanced closing non-block tags don't break a list\n(Parsoid-only since php parser generates broken html -- relies on Tidy to fix up) [3,3,[0,3,1]]");
...
add("selser", "Unbalanced closing non-block tags don't break a list\n(Parsoid-only since php parser generates broken html -- relies on Tidy to fix up) [3,0,[[4,1],0,1]]");
...
add("selser", "Ref: 14. A nested ref-tag should be emitted as plain text [1,3,0]");
add("selser", "Ref: 14. A nested ref-tag should be emitted as plain text [2,0,0]");
add("selser", "Ref: 14. A nested ref-tag should be emitted as plain text [2,3,0]");
add("selser", "Ref: 14. A nested ref-tag should be emitted as plain text [1,2,0]");
add("selser", "Ref: 14. A nested ref-tag should be emitted as plain text [1,0,0]");
add("selser", "Ref: 14. A nested ref-tag should be emitted as plain text [1,4,0]");
add("selser", "Ref: 14. A nested ref-tag should be emitted as plain text [2,4,0]");
add("selser", "Ref: 14. A nested ref-tag should be emitted as plain text [[0,4],0,0]");
add("selser", "Ref: 14. A nested ref-tag should be emitted as plain text [[0,3],0,0]");
add("selser", "Ref: 14. A nested ref-tag should be emitted as plain text [[0,2],4,0]");
add("selser", "Ref: 14. A nested ref-tag should be emitted as plain text [0,4,0]");
add("selser", "Ref: 14. A nested ref-tag should be emitted as plain text [[0,3],3,0]");
add("selser", "Ref: 14. A nested ref-tag should be emitted as plain text [[0,2],0,0]");
add("selser", "Ref: 14. A nested ref-tag should be emitted as plain text [[0,3],2,0]");
