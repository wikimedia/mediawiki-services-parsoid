...
add("selser", "Paragraphs with extra newline spacing [[2],0,1,0,2,0,[3],0,3,[3]]", "foo\n\nbar\n\nh9tjlgp8vnqgds4i\n\nbaz\n\n\n\nbooz");
add("selser", "Paragraphs with newline spacing with comment lines in between [4,4,[4,3,0],0,0,2,0,4,2,3,[3,4,3,3,3,4,3],3,0,2,0,0,4,3,4,0,2,3,0,0,0,2,4,3,4,0,[2],2,0,0,[0,2],0,4,3,4,0,2,4,1]", "ljtjoaz8zci8uxr\n\na\n<!--foo-->\nb\n----\na\n<!--foo--><!--More than 1 comment, still stripped-->\nb\nr7klgjd9kevfs9k9\n----\na\n <!--foo--> <!----> <!-- bar --> \nb\n----\na\n<!--foo-->\n\nk60g8c3n2dzehfr\ntasxmhs9hhorms4i\n----\na\n\n<!--foo-->\n10rd64fsf62sm7vi\ne6wd624e8gwah5mi\n\na\n<!--foo-->\n\n\nb\nr0g0rec4gfkwqaor\nx982rufrsirafw29\n\no99dl93h9hi1kyb9\n<!--foo-->\n\nb\n----");
...
add("selser", "Paragraphs with newline spacing with non-empty mixed comment and white-space lines in between [4,3,[4,2,4],3,3,3,[4,0,0,4],2,0,3,1,0,0,0,3,0,[2],0,0,3,3,0,0,0,3,3,[0,4],0,3]", "xsvzlo6wmmml5wmi\n\na\n <!--foo-->\nb\n\na\n <!--foo--><!--More than 1 comment doesn't disable stripping of this line!-->\nb\n----\na\n \n<!--foo-->\n <!--bar-->\nb\n----\n\n \n <!--foo-->\n<!--bar--> \nb\n");
...
add("selser", "Italics and possessives (3) [[0,2,0,[3],4,[4,1],0,0,0]]", "The first monolingual dictionary written in a Romance language was 86ftvkdoog5vcxr''Sebastián Covarrubias''' ''Tesoro de la lengua castellana o española'', published in 1611 in Madrid. In 1612 the first edition of the ''<nowiki>Vocabolario dell'</nowiki>[[Accademia della Crusca]]'', for Italian, was published. In 1690 in Rotterdam was published, posthumously, the ''Dictionnaire Universel''.");
...
add("selser", "Italics and possessives (3) [[0,0,0,[3],4,[0,1],3,4,3]]", "The first monolingual dictionary written in a Romance language was ''Sebastián Covarrubias''' ''Tesoro de la lengua castellana o española'', published in 1611 in Madrid. In 1612 the first edition of the ''<nowiki>Vocabolario dell'</nowiki>[[Accademia della Crusca]]'', for Italian, was published. In 1690 in Rotterdam was published, posthumously, the rb7a0m6g4banstt9.");
add("selser", "Italics and possessives (3) [[2,[4],0,3,0,[0,1],0,[3],2]]", "The first monolingual dictionary written in a Romance language was ''Sebastián Covarrubias''' , published in 1611 in Madrid. In 1612 the first edition of the ''<nowiki>Vocabolario dell'</nowiki>[[Accademia della Crusca]]'', for Italian, was published. In 1690 in Rotterdam was published, posthumously, the ''Dictionnaire Universel''.");
...
add("selser", "Italics and possessives (3) [[0,[3],0,1,3,1,0,2,0]]", "The first monolingual dictionary written in a Romance language was ''Sebastián Covarrubias''' ''Tesoro de la lengua castellana o española'', published in 1611 in Madrid. In 1612 the first edition of the ''<nowiki>Vocabolario dell'</nowiki>[[Accademia della Crusca]]'', for Italian, was published. In 1690 in Rotterdam was published, posthumously, the hhstwc14sq19vn29''Dictionnaire Universel''.");
...
add("selser", "Italics and bold: multiple quote sequences: (2,4,2) [[[2,2]]]", "''<nowiki>foo'</nowiki>7dbqxyys8suac3di'''bar''");
...
add("selser", "Italics and bold: multiple quote sequences: (2,4,2) [[[3,2]]]", "''<nowiki>foo'</nowiki>24pn2nqujyfu5wmi'''bar''");
...
add("selser", "Italics and bold: multiple quote sequences: (2,4,2) [[[0,2]]]", "''<nowiki>foo'</nowiki>iuptdv9rlkcblnmi'''bar''");
...
add("selser", "Italics and bold: multiple quote sequences: (2,4,4) [[[4,2]]]", "''<nowiki>foo'</nowiki>1qu8sera3dydgqfr'''bar''''''");
...
add("selser", "Italics and bold: multiple quote sequences: (2,4,4) [[[2,2]]]", "''<nowiki>foo'</nowiki>roraqfsx2sz1714i'''bar''''''");
...
add("selser", "Italics and bold: multiple quote sequences: (2,4,4) [[[0,2]]]", "''<nowiki>foo'</nowiki>lqyaxwl4rlmu0udi'''bar''''''");
...
add("selser", "Tabs don't trigger preformatted text [2]", "l7wt6v8iaiwzh0k9\n\tThis is not\n\t preformatted text.\n This is preformatted text.\n \tSo is this.");
...
add("selser", "4. Multiple spaces at start-of-line [2,0,0,2]", "    <p> foo </p>\njmxd0hb7sz1wnrk9\n    foo\n\t{|\n|foo\n|}");
add("selser", "4. Multiple spaces at start-of-line [2,2,0,2]", "    zob5sdimzbzqia4i<p> foo </p>\n0ngw4sd25b87iudi\n    foo\n\t{|\n|foo\n|}");
...
add("selser", "6. Pre-blocks should extend across lines with leading WS even when there is no wrappable content [3,3,2,2,3]", "\ns0pc83i87b6v42t9\n c \n");
...
add("selser", "Definition list with URL link [[1,0]]", "; http://example.com/: definition");
add("selser", "Definition list with URL link [[1,[3]]]", "; http://example.com/: definition");
...
add("selser", "Definition lists: self-closed tag [[[4,0,2,0],4]]", ";one<br/>two 6gd5x9ujq93sor");
...
add("selser", "Definition lists: self-closed tag [[[3,0,0,1],2]]", ";one<br/>two ous26d8paeqrrudi: two-line fun");
...
add("selser", "External links: wiki links within external link (Bug 3695) [[4,[2],4]]", "l011hqujbm3zyqfr[[wikilink]]  embedded in ext link");
add("selser", "External links: wiki links within external link (Bug 3695) [[0,0,3]]", "[http://example.com [[wikilink]] embedded in ext link]");
add("selser", "External links: wiki links within external link (Bug 3695) [2]", "rfn3et25sei885mi\n\n[http://example.com [[wikilink]] embedded in ext link]");
add("selser", "External links: wiki links within external link (Bug 3695) [[1,0,0]]", "[http://example.com ][[wikilink]]  embedded in ext link");
add("selser", "External links: wiki links within external link (Bug 3695) [1]", "[http://example.com [[wikilink]] embedded in ext link][[wikilink]]  embedded in ext link");
add("selser", "External links: wiki links within external link (Bug 3695) [[0,[2],4]]", "[http://example.com [[wikilink]] embedded in ext link]");
add("selser", "External links: wiki links within external link (Bug 3695) [[0,1,0]]", "[http://example.com [[wikilink]] embedded in ext link][[wikilink]] embedded in ext link");
add("selser", "External links: wiki links within external link (Bug 3695) [[3,[3],3]]", "[[wikilink]]  embedded in ext link");
add("selser", "External links: wiki links within external link (Bug 3695) [[1,[4],3]]", "[http://example.com ][[wikilink]]  embedded in ext link");
add("selser", "External links: wiki links within external link (Bug 3695) [[0,[4],2]]", "[http://example.com [[wikilink]] embedded in ext link]");
add("selser", "External links: wiki links within external link (Bug 3695) [[0,[3],4]]", "[http://example.com [[wikilink]] embedded in ext link]");
add("selser", "External links: wiki links within external link (Bug 3695) [[2,0,3]]", "293cbx0l3sg7gb9[http://example.com [[wikilink]] embedded in ext link][[wikilink]]  embedded in ext link");
add("selser", "External links: wiki links within external link (Bug 3695) [[0,2,4]]", "[http://example.com [[wikilink]] embedded in ext link]rc54l2ht7oh9qkt9[[wikilink]]  embedded in ext link");
add("selser", "External links: wiki links within external link (Bug 3695) [[0,0,4]]", "[http://example.com [[wikilink]] embedded in ext link]");
add("selser", "External links: wiki links within external link (Bug 3695) [[2,3,0]]", "ajav6f9s210dx6r[http://example.com [[wikilink]] embedded in ext link] embedded in ext link");
add("selser", "External links: wiki links within external link (Bug 3695) [[0,2,0]]", "[http://example.com [[wikilink]] embedded in ext link]pj9l2glwx6sf9a4i[[wikilink]]  embedded in ext link");
add("selser", "External links: wiki links within external link (Bug 3695) [[0,4,0]]", "[http://example.com [[wikilink]] embedded in ext link]2zzejaf2y9nc23xr embedded in ext link");
add("selser", "External links: wiki links within external link (Bug 3695) [[3,2,0]]", "0uk611ztql8wu3di[[wikilink]]  embedded in ext link");
add("selser", "Bug 2702: Mismatched <i>, <b> and <a> tags are invalid [[3,0,[2],0,3,4,3,0,0,[1]]]", "\n[http://example.com 4n2162e1fd730udi'''text''']\n\n''', even bold]\n'''''Now [http://example.com both''''']'''''\n");
add("selser", "Bug 2702: Mismatched <i>, <b> and <a> tags are invalid [1]", "''[http://example.com text'']\n[\n\n[http://example.com '''text]\n''Something [http://example.com in italic'']\n'\n\n''Something [http://example.com mixed''''', even bold]''''', even bold]\n'''''Now [http://example.com both''''']\n");
add("selser", "Bug 2702: Mismatched <i>, <b> and <a> tags are invalid [2]", "ypjgrwin4revcxr\n\n''[http://example.com text'']\n[http://example.com '''text]'''\n''Something [http://example.com in italic'']\n''Something [http://example.com mixed''''', even bold]'''\n'''''Now [http://example.com both''''']");
add("selser", "Bug 2702: Mismatched <i>, <b> and <a> tags are invalid [[0,2,[3],2,3,2,2,0,0,[[3,3]]]]", "''[http://example.com text'']\n[\n[http://example.com ]\n\nyrczp6ccq6vcmcxr\n''Something [http://example.com mixed''''', even bold]''''', even bold]\n'''''Now '''''\n");
add("selser", "Bug 2702: Mismatched <i>, <b> and <a> tags are invalid [[2,0,4,4,1,2,[3,[4]],4,0,[[0,2]]]]", "fxsbmxalr8f9wwmi''[http://example.com text'']\n[\ng1cxmyk709vygb9\n''Something [http://example.com in italic'']''\n\n''Something [http://example.com mixed''''', even bold]''c6f6w79eiwfjemi\n'''''Now 44xfkl1uikfenrk9[http://example.com both''''']'''''\n");
add("selser", "Bug 2702: Mismatched <i>, <b> and <a> tags are invalid [[4,0,0,0,[4,4],4,[0,3],[1],0,[[0,[4]]]]]", "0zdw3pkk57hnnrk9\n\n[http://example.com '''text]\n''Something izanpf6huff20529''\n''Something ''[http://example.com ''', even bold''']\n'''''Now [http://example.com both''''']\n");
add("selser", "Bug 2702: Mismatched <i>, <b> and <a> tags are invalid [[1,3,2,3,[2,4],0,[4,0],[4],0,4]]", "''[http://example.com text'']''\n9ois0yoxiebfbt9\n[http://example.com '''text]\n''Something saoppxketkic0udi''\n\n''Something [http://example.com mixed''''', even bold]''[http://example.com 2mgo6fhhdad78pvi]\no0hyqnpaq38cwhfr");
add("selser", "Bug 2702: Mismatched <i>, <b> and <a> tags are invalid [[[3],0,[2],0,3,2,[4,2],3,0,1]]", "''''\n[http://example.com rgkc3a28h38cwhfr'''text]\n\n''Something fuoqrsdna64dkj4i[http://example.com mixed]''\n'''''Now [http://example.com both]'''''\n");
add("selser", "Bug 2702: Mismatched <i>, <b> and <a> tags are invalid [[3,0,3,2,[3,4],4,2,0,0,[1]]]", "\n''Something 08c54dlxojwf80k9''\nz032w7z1kdo0f6r\n''Something [http://example.com mixed''''', even bold]''''', even bold]\n'''''Now [http://example.com both''''']'''''\n");
add("selser", "Bug 2702: Mismatched <i>, <b> and <a> tags are invalid [[2,2,[2],2,[0,3],0,[0,3],[3],0,[[0,3]]]]", "o9nab4h230tnvcxr''[http://example.com text'']\n[\n[http://example.com u5sfhyznivd3g14i'''text]\n''Something ''\n''Something ''[http://example.com ]\n'''''Now '''''\n");
add("selser", "Bug 2702: Mismatched <i>, <b> and <a> tags are invalid [[[2],4,[[4]],0,4,0,[4,2],2,3,[4]]]", "''kndlu276kxz5b3xr[http://example.com text'']''\n\n[http://example.com '''text]\n66fz4jk56gtd42t9\n''Something hbtqecdqt5oecdi[http://example.com mixed''''', even bold]''sr9o6vidsk5u3di''', even bold]\n''81gi1py5yann4s4i''\n");
add("selser", "Bug 2702: Mismatched <i>, <b> and <a> tags are invalid [[2,0,3,0,2,3,[0,3],2,0,1]]", "rxaa2sxf4o8yqfr''[http://example.com text'']\n[\n\nmtebxw1xl4x11yvi''Something [http://example.com in italic'']\n'\n''Something ''vt2hxx23uta3v7vi''', even bold]\n'''''Now [http://example.com both''''']''\n");
add("selser", "Bug 2702: Mismatched <i>, <b> and <a> tags are invalid [[4,2,0,0,4,0,1,[4],2,[1]]]", "uypp3nxnupst6gvi\n\n[http://example.com '''text]\n5lixlomwktb4vx6r\n''Something [http://example.com mixed''''', even bold]''[http://example.com s5ucqw1bludz33di]\n'''''Now [http://example.com both''''']'''''\n");
add("selser", "Bug 2702: Mismatched <i>, <b> and <a> tags are invalid [[0,0,3,0,4,3,0,[1],0,[3]]]", "''[http://example.com text'']\n[\n\nutcl2r0fq8lac3di\n\n''Something [http://example.com mixed''''', even bold]''[http://example.com ''', even bold''']\n''''\n");
add("selser", "Bug 2702: Mismatched <i>, <b> and <a> tags are invalid [[2,4,0,4,[2,1],2,[3,2],1,0,[[0,2]]]]", "pv9ge46otv86w29''[http://example.com text'']\n[\n\n[http://example.com '''text]\n''Something [http://example.com in italic]''\n''Something 10amjvk8ra1nhfr[http://example.com mixed''''', even bold]''[http://example.com ''', even bold]\n'''''Now l4tfdpdshpqilik9[http://example.com both''''']'''''\n");
add("selser", "Bug 2702: Mismatched <i>, <b> and <a> tags are invalid [[0,0,[4],4,[0,2],4,[0,4],[4],0,[[0,1]]]]", "''[http://example.com text'']\n[\n[http://example.com xh33ebkbpr639pb9]\n''Something ikqa3l7jkhrdlsor[http://example.com in italic'']''\n''Something h327flpc5pbsxlxr''[http://example.com 3icsd821v6de7b9]\n'''''Now [http://example.com both]'''''\n");
add("selser", "External link containing double-single-quotes in text embedded in italics (bug 4598 sanity check) [1]", "''Some [http://example.com/ pretty ''italics'' and stuff]!'italics'' and stuff]!''");
add("selser", "External link containing double-single-quotes in text embedded in italics (bug 4598 sanity check) [[[2,[3]],4,3]]", "''Some [http://example.com/ pretty ''italics'' and stuff]!'1w3c1yj3soklc8fr");
add("selser", "External link containing double-single-quotes in text embedded in italics (bug 4598 sanity check) [[3,2,4]]", "84nfgjn9o8g833diitalics'' and stuff]pgituli9pddvx6r");
add("selser", "External link containing double-single-quotes in text embedded in italics (bug 4598 sanity check) [[[0,2],[3,3],[3]]]", "''Some 4zngb219maolayvi[http://example.com/ pretty ''italics'' and stuff]''[http://example.com/ italics]!''");
add("selser", "External link containing double-single-quotes in text embedded in italics (bug 4598 sanity check) [[2,[0,2],0]]", "deoy7kjnad29be29''Some [http://example.com/ pretty ''italics'' and stuff]!'[http://example.com/ italicswngbgy5rosdu0udi'' and stuff]!''");
add("selser", "External link containing double-single-quotes in text embedded in italics (bug 4598 sanity check) [[4,0,[4]]]", "9vtrpv3k0hir7ldiitalics'' and stuff]!''");
add("selser", "External link containing double-single-quotes in text embedded in italics (bug 4598 sanity check) [[[2,0],1,1]]", "''Some [http://example.com/ pretty ''italics'' and stuff]!'[http://example.com/ italics'' and stuff]''!''");
add("selser", "External link containing double-single-quotes in text embedded in italics (bug 4598 sanity check) [[2,[3,1],0]]", "21vawsdhzjzcl3di''Some [http://example.com/ pretty ''italics'' and stuff]!'[http://example.com/ italics'' and stuff'']!''");
add("selser", "External link containing double-single-quotes in text embedded in italics (bug 4598 sanity check) [2]", "vinw9prvz4c84cxr\n\n''Some [http://example.com/ pretty ''italics'' and stuff]!''");
add("selser", "External link containing double-single-quotes in text embedded in italics (bug 4598 sanity check) [[3,[2,[4]],1]]", "italics'' and stuff]''!''");
add("selser", "External link containing double-single-quotes in text embedded in italics (bug 4598 sanity check) [[[3,0],4,0]]", "''Some [http://example.com/ pretty ''italics'' and stuff]!'x7y8nxyz625u3di!''");
add("selser", "External link containing double-single-quotes in text embedded in italics (bug 4598 sanity check) [[3,0,0]]", "italics'' and stuff]!''");
add("selser", "External link containing double-single-quotes in text embedded in italics (bug 4598 sanity check) [[4,0,3]]", "t77fwkq0whhvvx6ritalics'' and stuff]\n");
add("selser", "External link containing double-single-quotes in text embedded in italics (bug 4598 sanity check) [[[2,0],[0,2],3]]", "''Some [http://example.com/ pretty ''italics'' and stuff]!'[http://example.com/ italicsgnxri8awc3w0cnmi'' and stuff]\n");
add("selser", "External link containing double-single-quotes in text embedded in italics (bug 4598 sanity check) [[4,[3,0],[4]]]", "zz3kdibovhlrf6ritalics'' and stuff]!''");
add("selser", "External link containing double-single-quotes in text embedded in italics (bug 4598 sanity check) [[[0,1],[3,[3]],0]]", "''Some [http://example.com/ pretty ]''italics'' and stuff]!''");
add("selser", "External link containing double-single-quotes in text embedded in italics (bug 4598 sanity check) [[3,3,0]]", "!''");
add("selser", "External link containing double-single-quotes with no space separating the url from text in italics [[0,1,2]]", "[http://www.musee-picasso.fr/pages/page_id18528_u1l2.htm''La muerte de Casagemas'' (1901) en el sitio de [[Museo Picasso (París)|Museo Picasso]].][[Museo Picasso (París)|Museo Picasso]].");
...
add("selser", "External link containing double-single-quotes with no space separating the url from text in italics [1]", "[http://www.musee-picasso.fr/pages/page_id18528_u1l2.htm''La muerte de Casagemas'' (1901) en el sitio de [[Museo Picasso (París)|Museo Picasso]].][[Museo Picasso (París)|Museo Picasso]]..");
add("selser", "External link containing double-single-quotes with no space separating the url from text in italics [[2,0,0]]", "3owjotpl28qqto6r[http://www.musee-picasso.fr/pages/page_id18528_u1l2.htm''La muerte de Casagemas'' (1901) en el sitio de [[Museo Picasso (París)|Museo Picasso]].][[Museo Picasso (París)|Museo Picasso]]..");
add("selser", "External link containing double-single-quotes with no space separating the url from text in italics [[[[4],4],2,0]]", "[http://www.musee-picasso.fr/pages/page_id18528_u1l2.htm''La muerte de Casagemas'' (1901) en el sitio de [[Museo Picasso (París)|Museo Picasso]].]epe48j1yfhcl3di[[Museo Picasso (París)|Museo Picasso]]..");
add("selser", "External link containing double-single-quotes with no space separating the url from text in italics [[2,[3],0]]", "76vwlxnsrpyqr529[http://www.musee-picasso.fr/pages/page_id18528_u1l2.htm''La muerte de Casagemas'' (1901) en el sitio de [[Museo Picasso (París)|Museo Picasso]].][[Museo Picasso (París)|Museo Picasso]]..");
add("selser", "External link containing double-single-quotes with no space separating the url from text in italics [[0,0,4]]", "[http://www.musee-picasso.fr/pages/page_id18528_u1l2.htm''La muerte de Casagemas'' (1901) en el sitio de [[Museo Picasso (París)|Museo Picasso]].]");
add("selser", "External link containing double-single-quotes with no space separating the url from text in italics [[[4,0],0,3]]", "[http://www.musee-picasso.fr/pages/page_id18528_u1l2.htm m80ag44dkvxtj4i (1901) en el sitio de ][[Museo Picasso (París)|Museo Picasso]]..");
add("selser", "External link containing double-single-quotes with no space separating the url from text in italics [[[3,3],[4],0]]", "[http://www.musee-picasso.fr/pages/page_id18528_u1l2.htm  (1901) en el sitio de ][[Museo Picasso (París)|Museo Picasso]]..");
add("selser", "External link containing double-single-quotes with no space separating the url from text in italics [[[[2],0],2,0]]", "[http://www.musee-picasso.fr/pages/page_id18528_u1l2.htm''La muerte de Casagemas'' (1901) en el sitio de [[Museo Picasso (París)|Museo Picasso]].]3wxnc8ynyul92j4i[[Museo Picasso (París)|Museo Picasso]]..");
add("selser", "External link containing double-single-quotes with no space separating the url from text in italics [[0,[3],3]]", "[http://www.musee-picasso.fr/pages/page_id18528_u1l2.htm''La muerte de Casagemas'' (1901) en el sitio de [[Museo Picasso (París)|Museo Picasso]].]");
add("selser", "External link containing double-single-quotes with no space separating the url from text in italics [[3,[3],3]]", "[[Museo Picasso (París)|Museo Picasso]]..");
add("selser", "External link containing double-single-quotes with no space separating the url from text in italics [[[0,4],4,3]]", "[http://www.musee-picasso.fr/pages/page_id18528_u1l2.htm''La muerte de Casagemas'' (1901) en el sitio de [[Museo Picasso (París)|Museo Picasso]].]25qkmdg9uocu9pb9.");
add("selser", "External link containing double-single-quotes with no space separating the url from text in italics [[4,0,3]]", "s7cmk1ocalpd5cdi[[Museo Picasso (París)|Museo Picasso]]..");
add("selser", "External link containing double-single-quotes with no space separating the url from text in italics [[[1,2],2,4]]", "[http://www.musee-picasso.fr/pages/page_id18528_u1l2.htm ''La muerte de Casagemas'' (1901) en el sitio de ]wvn1dm0gv694fgvi[[Museo Picasso (París)|Museo Picasso]]..");
...
add("selser", "Multiplication table [[0,[2],2,2]]", "{| border=\"1\" cellpadding=\"2\"\n|+Multiplication table\n|-\n! &times; !! 1 !! 2 !! 3\n|-\n! 1\n| 1 || 2 || 3\n|-\n! 2\n| 2 || 4 || 6\n|-\n! 3\n| 3 || 6 || 9\n|-\n! 4\n| 4 || 8 || 12\n|-\n! 5\n| 5 || 10 || 15\n|}");
add("selser", "Multiplication table [[4,1,4,[[0,[0,1,4],3,1,0],0,2,0,1,0,[0,2,2,2,2,[2]],0,3,0,[4,0,0,3,0,4],0]]]", "{| border=\"1\" cellpadding=\"2\"\n|+ data-foobar=\"t57h9ymm47m8to6r\" |Multiplication table\n|-\n! &times; !! data-foobar=\"2d6yfgysmtervn29\" | 2 !! 3\n|-\n! 1\n| 1 || 2 || 3\n|- data-foobar=\"p8wukztcsor\"\n! 2\n| 2 || 4 || 6\n|-\n<!--z4x3tc8wjojvpldi-->! 3\n| 3 <!--45occllzgehr529-->|| 6 || 9\n\n|-\n! 5\n|| 10 <!--rpawa6o0v902uik9-->\n|}");
...
add("selser", "Link containing double-single-quotes '' in text embedded in italics (bug 4598 sanity check) [[[2,0],2,[2]]]", "''Some [[Link|pretty ''italics'' and stuff]]!8bqth44ymji3soritalics'' and stuff]]!");
add("selser", "Link containing double-single-quotes '' in text embedded in italics (bug 4598 sanity check) [[1,3,1]]", "''Some [[Link|pretty ''italics'' and stuff]]''''!''");
add("selser", "Link containing double-single-quotes '' in text embedded in italics (bug 4598 sanity check) [[[4,0],1,4]]", "''Some [[Link|pretty ''italics'' and stuff]]![[Link|italics'' and stuff]]<nowiki/>b8hzil1zrzbh85mi");
add("selser", "Link containing double-single-quotes '' in text embedded in italics (bug 4598 sanity check) [[[3,[2]],0,0]]", "''Some [[Link|pretty ''italics'' and stuff]]!");
add("selser", "Link containing double-single-quotes '' in text embedded in italics (bug 4598 sanity check) [[[0,3],1,0]]", "''Some ''[[Link|italics'' and stuff]]!");
...
add("selser", "Link containing double-single-quotes '' in text embedded in italics (bug 4598 sanity check) [[[4,[3]],3,4]]", "''Some [[Link|pretty ''italics'' and stuff]]!gifs6gh27p0hpvi");
add("selser", "Link containing double-single-quotes '' in text embedded in italics (bug 4598 sanity check) [[1,4,1]]", "''Some [[Link|pretty ''italics'' and stuff]]''oxirwqxe66uk57b9''!''");
add("selser", "Link containing double-single-quotes '' in text embedded in italics (bug 4598 sanity check) [[[2,2],[0,[3]],3]]", "''Some 85y8ok4trhzuayvi[[Link|pretty ''italics'' and stuff]]''italics'' and stuff]]\n");
add("selser", "Link containing double-single-quotes '' in text embedded in italics (bug 4598 sanity check) [[[0,[2]],4,[2]]]", "''Some [[Link|pretty ''italics'' and stuff]]!cc3u2t2iqj16ecdi!");
add("selser", "Link containing double-single-quotes '' in text embedded in italics (bug 4598 sanity check) [[[0,[4]],[3,0],2]]", "''Some [[Link|pretty ''italics'' and stuff]]!italics'' and stuff]]0s4d0423qd3lq5mi!");
add("selser", "Link containing double-single-quotes '' in text embedded in italics (bug 4598 sanity check) [[[3,3],2,0]]", "''Some ''aca20lhtf3zbyb9italics'' and stuff]]!");
add("selser", "Link containing double-single-quotes '' in text embedded in italics (bug 4598 sanity check) [[[0,[3]],[4,4],3]]", "''Some [[Link|pretty ''italics'' and stuff]]![[Link|italicspm0h4m5tolp7gb9]]\n");
add("selser", "Link containing double-single-quotes '' in text embedded in italics (bug 4598 sanity check) [1]", "''Some [[Link|pretty ''italics'' and stuff]]!italics'' and stuff]]!");
add("selser", "Link containing double-single-quotes '' in text embedded in italics (bug 4598 sanity check) [[2,1,2]]", "zj35cbwfnut0529''Some [[Link|pretty ''italics'' and stuff]]![[Link|italics'' and stuff]]<nowiki/>kt7bnuzwbjf6flxr!");
add("selser", "Link containing double-single-quotes '' in text embedded in italics (bug 4598 sanity check) [[4,0,2]]", "cq6qf1b7g7c1h5miitalics'' and stuff]]vhp7j9qto0cc8fr!");
add("selser", "BUG 2: [[page|http://url/]] should link to page, not http://url/ [2]", "vojlx8zbglqbbj4i\n\n[[Main Page|http://url/]]");
add("selser", "BUG 2: [[page|http://url/]] should link to page, not http://url/ [1]", "[[Main Page|http://url/]]http://url/\n");
add("selser", "BUG 2: [[page|http://url/]] should link to page, not http://url/ [[2,0]]", "nq9wl694worvbo6r[[Main Page|http://url/]]http://url/\n");
add("selser", "BUG 2: [[page|http://url/]] should link to page, not http://url/ [[2,2]]", "kdgp3166s2fyldi[[Main Page|http://url/]]wz4j22zf07pn9udihttp://url/\n");
...
add("selser", "BUG 2: [[page|http://url/]] should link to page, not http://url/ [[0,2]]", "[[Main Page|http://url/]]3e33a4nvfs9k9http://url/\n");
...
add("selser", "2. includeonly in html attr value [[0,0,3,0,0]]", "<span id=\"<noinclude>v1</noinclude><includeonly>v2</includeonly>\">bar</span>\n<span id=<noinclude>\"v1\"</noinclude><includeonly>\"v2\"</includeonly>>bar</span>");
add("selser", "2. includeonly in html attr value [[0,0,4,0,0]]", "<span id=\"<noinclude>v1</noinclude><includeonly>v2</includeonly>\">bar</span>\n<span id=<noinclude>\"v1\"</noinclude><includeonly>\"v2\"</includeonly>>bar</span>");
add("selser", "2. includeonly in html attr value [2]", "u352zdrjeccsdcxr\n\n<span id=\"<noinclude>v1</noinclude><includeonly>v2</includeonly>\">bar</span>\n<span id=<noinclude>\"v1\"</noinclude><includeonly>\"v2\"</includeonly>>bar</span>");
add("selser", "2. includeonly in html attr value [[0,0,2,0,0]]", "<span id=\"<noinclude>v1</noinclude><includeonly>v2</includeonly>\">bar</span>\n<span id=<noinclude>\"v1\"</noinclude><includeonly>\"v2\"</includeonly>>bar</span>");
...
add("selser", "Empty attribute crash test (bug 2067) [[[4]]]", "<font color=\"\">foo</font>");
add("selser", "Empty attribute crash test (bug 2067) [1]", "<font color=\"\">foo</font>");
add("selser", "Empty attribute crash test (bug 2067) [[[2]]]", "<font color=\"\">foo</font>");
add("selser", "Empty attribute crash test (bug 2067) [2]", "tdn6c7huq1vy4x6r\n\n<font color=\"\">foo</font>");
add("selser", "Empty attribute crash test (bug 2067) [[[3]]]", "<font color=\"\">foo</font>");
add("selser", "Empty attribute crash test (bug 2067) [[2]]", "wmcd7ayzoyxh6w29<font color=\"\">foo</font>");
...
add("selser", "Bug 2095: link with pipe and three closing brackets, version 2 [[3,[2]]]", "[http://example.com/]]]");
add("selser", "Bug 2095: link with pipe and three closing brackets, version 2 [[0,[2]]]", "[[Main Page|[http://example.com/]]]");
add("selser", "Bug 2095: link with pipe and three closing brackets, version 2 [[0,[4]]]", "[[Main Page|[http://example.com/]]]");
add("selser", "Bug 2095: link with pipe and three closing brackets, version 2 [[2,3]]", "h4wq9ivlle1xlxr[[Main Page|[http://example.com/]]]");
add("selser", "Bug 2095: link with pipe and three closing brackets, version 2 [[3,2]]", "99keiiqxlrp5jyvi[http://example.com/]]]");
add("selser", "Bug 2095: link with pipe and three closing brackets, version 2 [[0,1]]", "[[Main Page|[http://example.com/]]][http://example.com/]");
add("selser", "Bug 2095: link with pipe and three closing brackets, version 2 [[1,[3]]]", "[[Main Page|<nowiki/>]][http://example.com/]]]");
...
add("selser", "Bug 2095: link with pipe and three closing brackets, version 2 [[4,0]]", "c9tbsesncl5idx6r[http://example.com/]]]");
...
add("selser", "Sanitizer: Validating that <meta> and <link> work, but only for Microdata [[2,[0,0,2,0,0,0,0],0]]", "<div itemscope>\n\t<meta itemprop=\"hello\" content=\"world\">\n\t<meta http-equiv=\"refresh\" content=\"5\">\n\t<meta itemprop=\"hello\" http-equiv=\"refresh\" content=\"5\">\n\t<link itemprop=\"hello\" href=\"{{SERVER}}\">\n\t<link rel=\"stylesheet\" href=\"{{SERVER}}\">\n\t<link rel=\"stylesheet\" itemprop=\"hello\" href=\"{{SERVER}}\">\n</div>");
add("selser", "Sanitizer: Validating that <meta> and <link> work, but only for Microdata [2]", "rcydl379jopkqpvi<div itemscope>\n\t<meta itemprop=\"hello\" content=\"world\">\n\t<meta http-equiv=\"refresh\" content=\"5\">\n\t<meta itemprop=\"hello\" http-equiv=\"refresh\" content=\"5\">\n\t<link itemprop=\"hello\" href=\"{{SERVER}}\">\n\t<link rel=\"stylesheet\" href=\"{{SERVER}}\">\n\t<link rel=\"stylesheet\" itemprop=\"hello\" href=\"{{SERVER}}\">\n</div>");
add("selser", "Sanitizer: Validating that <meta> and <link> work, but only for Microdata [[0,[2,0,2,0,0,0,3],3]]", "<div itemscope>\n\t<meta itemprop=\"hello\" content=\"world\">\n\t<meta http-equiv=\"refresh\" content=\"5\">\n\t<meta itemprop=\"hello\" http-equiv=\"refresh\" content=\"5\">\n\t<link itemprop=\"hello\" href=\"{{SERVER}}\">\n\t<link rel=\"stylesheet\" href=\"{{SERVER}}\">\n\t<link rel=\"stylesheet\" itemprop=\"hello\" href=\"{{SERVER}}\">\n</div>");
add("selser", "Sanitizer: Validating that <meta> and <link> work, but only for Microdata [[4,[3,0,0,0,0,0,0],0]]", "<div itemscope>\n\t<meta itemprop=\"hello\" content=\"world\">\n\t<meta http-equiv=\"refresh\" content=\"5\">\n\t<meta itemprop=\"hello\" http-equiv=\"refresh\" content=\"5\">\n\t<link itemprop=\"hello\" href=\"{{SERVER}}\">\n\t<link rel=\"stylesheet\" href=\"{{SERVER}}\">\n\t<link rel=\"stylesheet\" itemprop=\"hello\" href=\"{{SERVER}}\">\n</div>");
add("selser", "Sanitizer: Validating that <meta> and <link> work, but only for Microdata [[0,[0,0,4,0,0,0,0],2]]", "<div itemscope>\n\t<meta itemprop=\"hello\" content=\"world\">\n\t<meta http-equiv=\"refresh\" content=\"5\">\n\t<meta itemprop=\"hello\" http-equiv=\"refresh\" content=\"5\">\n\t<link itemprop=\"hello\" href=\"{{SERVER}}\">\n\t<link rel=\"stylesheet\" href=\"{{SERVER}}\">\n\t<link rel=\"stylesheet\" itemprop=\"hello\" href=\"{{SERVER}}\">\n</div>");
add("selser", "Sanitizer: Validating that <meta> and <link> work, but only for Microdata [[0,[4,0,3,0,0,0,0],0]]", "<div itemscope>\n\t<meta itemprop=\"hello\" content=\"world\">\n\t<meta http-equiv=\"refresh\" content=\"5\">\n\t<meta itemprop=\"hello\" http-equiv=\"refresh\" content=\"5\">\n\t<link itemprop=\"hello\" href=\"{{SERVER}}\">\n\t<link rel=\"stylesheet\" href=\"{{SERVER}}\">\n\t<link rel=\"stylesheet\" itemprop=\"hello\" href=\"{{SERVER}}\">\n</div>");
add("selser", "Sanitizer: Validating that <meta> and <link> work, but only for Microdata [[0,[2,0,0,0,0,0,0],0]]", "<div itemscope>\n\t<meta itemprop=\"hello\" content=\"world\">\n\t<meta http-equiv=\"refresh\" content=\"5\">\n\t<meta itemprop=\"hello\" http-equiv=\"refresh\" content=\"5\">\n\t<link itemprop=\"hello\" href=\"{{SERVER}}\">\n\t<link rel=\"stylesheet\" href=\"{{SERVER}}\">\n\t<link rel=\"stylesheet\" itemprop=\"hello\" href=\"{{SERVER}}\">\n</div>");
add("selser", "Sanitizer: Validating that <meta> and <link> work, but only for Microdata [[0,[0,0,0,0,3,0,3],0]]", "<div itemscope>\n\t<meta itemprop=\"hello\" content=\"world\">\n\t<meta http-equiv=\"refresh\" content=\"5\">\n\t<meta itemprop=\"hello\" http-equiv=\"refresh\" content=\"5\">\n\t<link itemprop=\"hello\" href=\"{{SERVER}}\">\n\t<link rel=\"stylesheet\" href=\"{{SERVER}}\">\n\t<link rel=\"stylesheet\" itemprop=\"hello\" href=\"{{SERVER}}\">\n</div>");
...
add("selser", "Sanitizer: Validating that <meta> and <link> work, but only for Microdata [[3,[0,0,4,0,3,0,0],4]]", "<div itemscope>\n\t<meta itemprop=\"hello\" content=\"world\">\n\t<meta http-equiv=\"refresh\" content=\"5\">\n\t<meta itemprop=\"hello\" http-equiv=\"refresh\" content=\"5\">\n\t<link itemprop=\"hello\" href=\"{{SERVER}}\">\n\t<link rel=\"stylesheet\" href=\"{{SERVER}}\">\n\t<link rel=\"stylesheet\" itemprop=\"hello\" href=\"{{SERVER}}\">\n</div>");
...
add("selser", "Fuzz testing: Parser24 [3,2]", "u39lbr4wb5ptlnmi\n{|\n{{{|\n<u CLASS=\n| {{{{SSSll!!!!!!!VVVV)]]][[Special:*xxxxxxx--><noinclude>}}}} >\n<br style=\"onmouseover='alert(document.cookie);' \" />\n\nMOVE YOUR MOUSE CURSOR OVER THIS TEXT\n|");
add("selser", "Fuzz testing: Parser24 [[[3],0],2]", "aruqvd6sv8bvgqfr\n{|\n{{{|\n<u CLASS=\n| {{{{SSSll!!!!!!!VVVV)]]][[Special:*xxxxxxx--><noinclude>}}}} >\n<br style=\"onmouseover='alert(document.cookie);' \" />\n\nMOVE YOUR MOUSE CURSOR OVER THIS TEXT\n|");
add("selser", "Fuzz testing: Parser24 [2,4]", "zp55fn0uhjrio1or\n\nbywvnpoau9za1yvi");
add("selser", "Fuzz testing: Parser24 [0,2]", "78ok5mnhx8icz0k9\n{|\n{{{|\n<u CLASS=\n| {{{{SSSll!!!!!!!VVVV)]]][[Special:*xxxxxxx--><noinclude>}}}} >\n<br style=\"onmouseover='alert(document.cookie);' \" />\n\nMOVE YOUR MOUSE CURSOR OVER THIS TEXT\n|");
add("selser", "Fuzz testing: Parser24 [1,2]", "{{{|\n<u CLASS=2ee2y1k6jblkrzfr\n{|\n{{{|\n<u CLASS=\n| {{{{SSSll!!!!!!!VVVV)]]][[Special:*xxxxxxx--><noinclude>}}}} >\n<br style=\"onmouseover='alert(document.cookie);' \" />\n\nMOVE YOUR MOUSE CURSOR OVER THIS TEXT\n|");
add("selser", "Fuzz testing: Parser24 [[3,0],2]", "<nowiki>|\n<u CLASS=</nowiki>vtpmggos1rxm9529\n{|\n{{{|\n<u CLASS=\n| {{{{SSSll!!!!!!!VVVV)]]][[Special:*xxxxxxx--><noinclude>}}}} >\n<br style=\"onmouseover='alert(document.cookie);' \" />\n\nMOVE YOUR MOUSE CURSOR OVER THIS TEXT\n|");
add("selser", "Fuzz testing: Parser24 [[1,2],2]", "{{{|\n<u CLASS=6xvikssdmi4zehfr\n{|\n{{{|\n<u CLASS=\n| {{{{SSSll!!!!!!!VVVV)]]][[Special:*xxxxxxx--><noinclude>}}}} >\n<br style=\"onmouseover='alert(document.cookie);' \" />\n\nMOVE YOUR MOUSE CURSOR OVER THIS TEXT\n|");
...
add("selser", "HTML5 data attributes [4,2,[2]]", "thvdwja4e7ugzaor\n<p data-abc-def_hij=\"\">Quuz</p>");
add("selser", "HTML5 data attributes [1,2,0]", "<span data-foo=\"bar\">Baz</span>\n<p data-abc-def_hij=\"\">Quuz</p>");
add("selser", "HTML5 data attributes [[4],3,2]", "c4xcmvw2i5yzxgvi\ns89q26dxoi4cmcxr<p data-abc-def_hij=\"\">Quuz</p>");
add("selser", "HTML5 data attributes [[2],3,[4]]", "fuj9grmt5canhfr<span data-foo=\"bar\">Baz</span>\n<p data-abc-def_hij=\"\">Quuz</p>");
add("selser", "HTML5 data attributes [[3],3,[4]]", "\n<p data-abc-def_hij=\"\">Quuz</p>");
add("selser", "HTML5 data attributes [[[2]],3,0]", "<span data-foo=\"bar\">Baz</span>\n<p data-abc-def_hij=\"\">Quuz</p>");
add("selser", "HTML5 data attributes [3,2,2]", "\nxkmtlk4fkx9io1or<p data-abc-def_hij=\"\">Quuz</p>");
add("selser", "HTML5 data attributes [3,0,0]", "\n<p data-abc-def_hij=\"\">Quuz</p>");
add("selser", "HTML5 data attributes [2,0,2]", "f76nqhmmquxr\n\n<span data-foo=\"bar\">Baz</span>\ngbahdm410dkdfgvi<p data-abc-def_hij=\"\">Quuz</p>");
add("selser", "HTML5 data attributes [[4],0,0]", "cs82qmr1qfc1sjor\n<p data-abc-def_hij=\"\">Quuz</p>");
...
add("selser", "Lists: 5. No unnecessary escapes [[4],2,[2],0,1,2,4,4,[2],0,[[3,0,4]]]", "*hyffvefmsd1jor\n\n*brmqa7lofn6lmcxr\n*=bar <span><nowiki>[[foo]]</nowiki></span>\n\n*[[bar <span><nowiki>[[foo]]</nowiki></span>\n\nw6tbu2ygsfapds4i\n\n*qsti51j9r6vquxr\n*=bar <span>foo]]</span>=\n\n* <s></s>: a");
...
add("selser", "1. Quotes inside <b> and <i> [[2,0,[4],0,[2],2,[2],3,0,1,3,1,0,1,0,[[3],[[4]],4],3,4,1,2,0,3,0,2,4,1,4,3,0,3,4,3,3,4,0,3,0,2]]", "sx87l4zay3dnp14i''<nowiki>'foo'</nowiki>''\n''0kml3vuceuerk9''\n''1sbtzk31mw9afw29<nowiki>'''foo'''</nowiki>''\n''foo'''s\n'''<nowiki>'foo'</nowiki>'''\n'''<nowiki>''foo''</nowiki>'''\n'''<nowiki>'''foo'''</nowiki>'''\n'''<nowiki>foo'</nowiki>''<nowiki>bar'</nowiki>''baz'''\n0ldjzsoeaomq85mi<nowiki/>'s\n'''foo''\n''foo''fd4pwvqpwqumcxr<nowiki/>'\n'<nowiki/>z6ecfej7h6r2uik9'\n'\n'\n'<nowiki/><nowiki/>'");
add("selser", "1. Quotes inside <b> and <i> [[[1],0,4,2,4,0,0,0,3,[1],4,1,3,0,0,1,3,0,0,0,[4],3,1,3,0,1,4,3,2,3,4,1,1,4,4,0,4,0]]", "''<nowiki>'foo'</nowiki>''\nw0pcxxar7ge3ik9\nbzleu526yptoi529\n''foo''<nowiki/>'s\n'''<nowiki>'foo'</nowiki>'''\n'''<nowiki>''foo''</nowiki>'''\n'''<nowiki>'''foo'''</nowiki>'''\n'''<nowiki>foo'</nowiki>''<nowiki>bar'</nowiki>''baz'''\n'''foo'''<nowiki/>'s\n'''foo''\n''foo'''\n'<nowiki/>t31umyu5wuibpgb9'\n'\n'''foo'''<nowiki/>'\n'5pfu21xak35zh0k9'''foo'''ilk7hsfpjl2l0udi'");
