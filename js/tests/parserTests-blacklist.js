...
add("wt2wt", "Parsoid-specific image handling - simple image with size and middle alignment");
add("wt2wt", "Parsoid-specific image handling - simple image with both sizes, a baseline alignment, and a caption");
...
add("selser", "SVG thumbnails with invalid language code [[0,[3]]]");
add("selser", "Parsoid-specific image handling - simple image with size and middle alignment [1]");
add("selser", "Parsoid-specific image handling - simple image with size and middle alignment [1]");
add("selser", "Parsoid-specific image handling - simple image with size and middle alignment [2]");
add("selser", "Parsoid-specific image handling - simple image with both sizes, a baseline alignment, and a caption [2]");
add("selser", "Parsoid-specific image handling - simple image with both sizes, a baseline alignment, and a caption 0");
add("selser", "Parsoid-specific image handling - simple image with both sizes, a baseline alignment, and a caption [1]");
