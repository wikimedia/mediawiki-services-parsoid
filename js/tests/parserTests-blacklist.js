...
add("selser", "Transclusion of a sibling page (one level up) true");
add("selser", "Transclusion of a child page true");
add("selser", "Non-transclusion because of too many up levels true");
